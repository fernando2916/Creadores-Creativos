...
import publicidad from '../../../../assets/StickerAdvertising.svg'
import user from '../../../../assets/StickerUserExperience.svg'
import seguridad from '../../../../assets/StickerSecurity.svg'
      ...
      <div className="my flex flex-col items-center justify-center md:mx-auto max-w-7xl">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-2 md:mx-5 ">
          <div className="shadow-lg shadow-cyan-950  bg-nav-900 rounded-xl mx-7 md:mx-2 p-7">
            <span>
              <img src={publicidad} alt="" className="p-5 w-32 md:w-44 justify-center mx-auto" />
            </span>
          ...
          <div className="shadow-lg shadow-cyan-950  bg-nav-900 rounded-xl mx-7 md:mx-2 p-7">
            {" "}
            <span>
              <img src={user} alt="" className="p-5 w-32 md:w-44 justify-center mx-auto" />
            </span>
            <div className=" text-center mx-auto">
          ...
          <div className="shadow-lg shadow-cyan-950  bg-nav-900 rounded-xl mx-7 md:mx-2 p-7">
            {" "}
            <span>
              <img src={seguridad} alt="" className="p-5 w-32 md:w-44 justify-center mx-auto" />
            </span>
            <div className=" text-center mx-auto">
