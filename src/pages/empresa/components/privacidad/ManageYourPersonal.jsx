...
import priv from '../../../../assets/PersonalData.svg'
      ...
      <div className=" grid md:grid-cols-12 max-w-7xl mx-5 md:mx-auto py-10 ">
        <div className="col-span-6 order-2 md:p-10">
          ...
          <div className="flex gap-10 my-5 max-w-lg items-center">
            <Link to='/perfil'>
            <button type="button" className="p-3 bg-btn-400 hover:bg-btn-600 transition-colors duration-150 rounded-lg font-semibold text-sm md:text-lg">
              Gestionar tus datos
            </button>
            </Link>
            <Link to='/privacidad/resumen'>
            <button type="button" className="text-link-100 hover:text-link-300 duration-150 transition-colors font-semibold flex items-center gap-2 text-sm md:text-lg ">
              Conocer más
              <FaAngleRight/>
            </button>
            </Link>
        ...
        <div className="col-span-6 px-10">
          <img src={priv} alt="" className="rounded-lg"/>
        </div>
      </div>
    </section>
  );
