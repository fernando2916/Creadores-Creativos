      ...
      <header className="pt-[4rem]">
        <div className="p-[3rem] md:py-[9rem] items-center mx-auto text-center bg-cont-100 ">
          <span className=" text-link-100 font-bold text-xs md:text-3xl">
            Agencia de Diseño Gráfico, Publicidad eh Impresión
          </span>
      ...
      <main className="m-5">
        {isWork ? (
          <>
            ...
            <ul className="grid grid-cols-1 gap-7 mt-10 lg:container mx-auto">
              {ItemsVacantes.map((item) => (
                <li key={item.Puesto}>
                  <div className="bg-nav-800 rounded-2xl flex flex-col md:flex-row p-5 md:items-center">
                    <div className=" sm:w-3/5 lg:w-4/5">
                    ...
                    <div className=" flex gap-5 sm:w-2/5 lg:w-1/5 items-center ">
                      <WorkInfo />
                      <WorkModal />
                    </div>
                  </div>
