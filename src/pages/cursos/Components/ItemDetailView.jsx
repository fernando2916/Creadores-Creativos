      ...
      <main>
        ...
        <section className="max-w-7xl mx-auto grid grid-cols-12 gap-2 p-5">
          <div className="col-span-full">
            ...
            <div className="bg-cont-100 rounded-lg">
              <Disclosure>
                <DisclosureButton className="group flex justify-between items-center gap-2 p-5 w-full" >
                  <div className="flex items-center">
                  <FaAngleDown className="w-5 group-data-[open]:rotate-180 transition-all duration-150"/>
                  Introduccion al Curso
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="">9 clases </span>
                    <FaCircle className="text-[5px]"/>
                    <span className=""> 27 min</span>
                  </div>
                </DisclosureButton>
