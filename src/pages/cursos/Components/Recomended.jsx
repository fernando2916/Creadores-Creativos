...
import { FaClock, FaDollarSign, FaHeart, FaLaptop, FaRegStar, FaShoppingCart, FaStar, FaYoutube } from "react-icons/fa"
import { FaEarthAmericas } from "react-icons/fa6"
import imagen from '../../../assets/marketing.webp'
...
export const Recomended = () => {
  return (
    <section className="max-w-7xl mx-5 lg:mx-auto m-10">
      ...
      <Link to='/cursos'>
      <button type="button" className="bg-btn-400 hover:bg-btn-600 transition-colors duration-150 rounded-md p-2 flex items-center gap-2 font-medium justify-center mx-auto mt-10">
      <FaLaptop/>
