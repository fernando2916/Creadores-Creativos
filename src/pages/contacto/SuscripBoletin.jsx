        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex flex-col md:flex-row space-y-3 max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex items-center mx-auto w-full md:w-1/3 justify-center gap-2 rounded-md bg-btn-400 px-3.5 py-2.5 text-sm md:text-lg font-semibold hover:bg-btn-600 transition-colors duration-150 "
                  >
                    <FaEnvelope/>
                Subscríbete
              </button>
