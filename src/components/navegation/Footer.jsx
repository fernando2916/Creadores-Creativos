...
import { compania, legal, menu, social, soporte } from "./NavItems";
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4" role="list">
                  {menu.map((item) => (
                    <li key={item.name}>
                      <Link to={item.href} className="hover:text-link-100">
                        {item.name}
                      </Link>
                    </li>
                  ))}
          ...
          <div className="flex space-x-6 md:order-2">
            {social.map((item) => (
              <Link
                ...
                key={item.name}
                target="_blank"
                className="text-link-100 hover:text-link-300 text-2xl">
