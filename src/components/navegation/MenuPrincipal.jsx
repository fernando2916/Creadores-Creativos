...
export const MenuPrincial = () => {
    return (
        ...
        <ul className="flex items-center justify-center gap-3 text-sm lg:text-base">
                  ...
                  <NavigationMenuLink>
                    <ul className="p-3 space-y-2 text-base">
                      {servicios.map((servicio) => (
                        ...
                        >
                          <Link to={servicio.href} className="flex items-center gap-2">
                            {servicio.icon}
                            {servicio.name}
                          </Link>
                        </li>
          ...
          <li className="hover:text-link-100 transition-colors duration-150">
            <Link to="/tienda" className="flex items-center gap-1">
              <FaShoppingBag />
              Tienda
            </Link>
          </li>
          <li className="hover:text-link-100 transition-colors duration-150">
            <Link to="/cursos" className="flex items-center gap-1">
              <FaVideo />
              Cursos
            </Link>
          </li>
