      ...
      <form className="pt-3 space-y-3 flex flex-col">
        <div className=" flex flex-col space-y-2">
          ...
          <input
            ...
            className="bg-transparent p-2 rounded-md border-link-100 border-2 outline-none "
          />
        </div>
        <div className=" flex flex-col space-y-2">
          <label className="font-medium text-lg">Apellido</label>
          <input
            type="text"
        ...
        <div className=" flex flex-col space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className="bg-transparent p-2 rounded-md border-link-100 border-2 outline-none  w-full"
            />
            <button
